import pkg from "@react-email/components";
const { Body, Container, Head, Heading, Html, Link, Preview, Text } = pkg;
  ...
  <Html lang="de" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text>
          vielen Dank für die Registrierung deines hackAIR home v2
          Feinstaubsensors "{device.name}" auf der openSenseMap!
        </Text>
        <Text>
          🎉 Damit deine Daten auch die openSenseMap erreichen, musst du noch
          deinen Feinstaubsensor konfigurieren. Eine Anleitung findest du unter{" "}
          <Link
