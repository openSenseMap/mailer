import {
  ...
  export const NewDeviceHackairEmail = ({user = {name: "Max Mustermann"}, device = {_id: "1234567890", name: "Hackair Test Gerät"}}: NewDeviceHackairEmailProps) => (
    <Html lang="de" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text>vielen Dank für die Registrierung deines hackAIR home v2 Feinstaubsensors "{device.name}" auf der openSenseMap!</Text>
          <Text>
            🎉 Damit deine Daten auch die openSenseMap erreichen, musst du noch deinen Feinstaubsensor konfigurieren. Eine Anleitung findest du unter <Link href="https://docs.sensebox.de/opensensemap/opensensemap-hackair/" target="_blank">https://docs.sensebox.de/opensensemap/opensensemap-hackair/</Link>.
          </Text>
